...
<template>
    ...
    <div class="min-h-screen bg-slate-50">
        ...
        <header class="bg-gradient-to-b from-amber-700 to-amber-800 px-4 py-4 shadow-md">
            <div class="max-w-2xl mx-auto flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-amber-200 text-xs">CNH e certidão de antecedentes</p>
                </div>
                <div class="ml-auto">
        ...
        <main class="max-w-2xl mx-auto px-4 py-6 space-y-5 pb-12">
            ...
            <section class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden"
                :class="!motorista.certidao_antecedentes_url ? 'ring-2 ring-amber-400' : ''">
                <div class="flex items-center gap-3 px-5 py-4 border-b border-amber-100 bg-amber-50/60">
                    <div class="w-8 h-8 rounded-xl bg-amber-700 flex items-center justify-center shrink-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-slate-500">Certidão atualizada (JPG, PNG ou PDF, até 5 MB)</p>
                    </div>
                ...
                <div class="px-5 py-4 space-y-3">
                    <p class="text-xs text-slate-500">
                        Disponível no site do Tribunal de Justiça do seu estado ou nos Correios.
                        Exigida pelo <strong class="text-slate-700">CONTRAN</strong> para transporte escolar remunerado.
                    </p>
