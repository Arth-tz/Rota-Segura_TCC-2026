...
return [
    ...
    'attributes'             => [
        ...
        'area'                             => 'área',
        'attributes.cnh_categoria'         => 'categoria da CNH',
        'attributes.cnh_numero'            => 'número da CNH',
        'attributes.cnh_validade'          => 'data de validade da CNH',
        'attributes.cpf'                   => 'CPF',
        'attributes.current_password'      => 'senha atual',
        'attributes.email'                 => 'e-mail',
        'attributes.first_name'            => 'nome',
        'attributes.last_name'             => 'sobrenome',
        'attributes.password'              => 'senha',
        'attributes.password_confirmation' => 'confirmação de senha',
        'attributes.phone'                 => 'telefone',
    ...
    'attributes' => [
        ...
        'nome'                  => 'nome',
        'telefone'              => 'telefone',
        'tipo_responsavel'      => 'tipo de responsavel',
        'email'                 => 'e-mail',
        'cpf'                   => 'CPF',
        'phone'                 => 'telefone',
        
        // Senhas (essencial para mensagens claras)
        'password'              => 'senha',
        'password_confirmation' => 'confirmação de senha',
        'current_password'      => 'senha atual',

        // Documentação (Motorista/Responsável)
        'cnh_numero'            => 'número da CNH',
        'cnh_categoria'         => 'categoria da CNH',
        'cnh_validade'          => 'data de validade da CNH',
        'rg'                    => 'RG',
        
        // Endereço (comum em cadastros desse tipo)
        'zip_code'              => 'CEP',
        'address'               => 'endereço',
        'number'                => 'número',
